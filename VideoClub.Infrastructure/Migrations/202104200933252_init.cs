    ...
    public partial class init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.MovieId, t.Genre })
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.UserId, t.Genre })
                .ForeignKey("dbo.AspNetUsers", t => t.UserId, cascadeDelete: true)
                .Index(t => t.UserId);
        ...
        {
            DropForeignKey("dbo.UserGenres", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Rentings", "User_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Rentings", "Copy_Id", "dbo.Copies");
            DropForeignKey("dbo.MovieGenres", "MovieId", "dbo.Movies");
            DropForeignKey("dbo.Copies", "Movie_Id", "dbo.Movies");
            ...
            DropIndex("dbo.Rentings", new[] { "User_Id" });
            DropIndex("dbo.Rentings", new[] { "Copy_Id" });
            DropIndex("dbo.MovieGenres", new[] { "MovieId" });
            DropIndex("dbo.Copies", new[] { "Movie_Id" });
